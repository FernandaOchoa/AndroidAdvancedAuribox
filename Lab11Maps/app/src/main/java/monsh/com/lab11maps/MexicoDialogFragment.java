...
public class MexicoDialogFragment extends DialogFragment {
    ...
    public MexicoDialogFragment() {
    }

    public static MexicoDialogFragment newInstance(String title, String fullSnippet) {
        MexicoDialogFragment fragment = new MexicoDialogFragment();
        Bundle b = new Bundle();
