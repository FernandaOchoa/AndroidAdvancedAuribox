package monsh.com.lab10firebasetodolist.Activities;
...
import monsh.com.lab10firebasetodolist.Models.ToDoItem;
import monsh.com.lab10firebasetodolist.R;
import monsh.com.lab10firebasetodolist.ToDoApplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FirebaseRecyclerViewAdapter<ToDoItem, ToDoItemViewHolder>(ToDoItem.class,
                R.layout.row,
                ToDoItemViewHolder.class,dataReference) {
            @Override
